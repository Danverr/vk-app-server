...
Имя ключа обозначает ориентацию ребра в графе доступа. **toId** - все входящие ребра, **fromId** - все выходящие. Учтите, что параметр в данном запросе может быть только один.
#### Ответ
