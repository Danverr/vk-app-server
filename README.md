...
## GET /entries/
Возвращает записи пользователя за день, месяц или за все время.

Записи отсортированы по убыванию даты создания.
#### Параметры
* **userId** *(обязательно)* - VK ID пользователя
...
* **photo_50** - URL 50x50 фотографии пользователя
* **photo_100** - URL 100x100 фотографии пользователя
#### Пример
```json
[
    {
        ...
        "photo_100": "https://sun9-49.userapi.com/c857416/v857416969/1a5de6/lq0BdyKaj9I.jpg?ava=1"
    }
]
```
